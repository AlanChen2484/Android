package com.easr.finalexam.other;
...
import com.easr.finalexam.home.SpecificActivity;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                intent.setClass(AddPrinter.this, SpecificActivity.class);
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            switch (menuItem.getItemId()) {
                case R.id.tick:
                    ...
                    intent1.setClass(AddPrinter.this, SpecificActivity.class);
